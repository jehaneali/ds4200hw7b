...
d3.csv("MBTA_Line_and_Stop.csv").then((data) => {
  {
      ...
      let lineData = [
        {time_period_id: 1, avg: 223},
        {time_period_id: 2, avg: 840},
        {time_period_id: 3, avg: 3114},
        {time_period_id: 4, avg: 2766},
        {time_period_id: 5, avg: 2022},
        {time_period_id: 6, avg: 3688},
        {time_period_id: 7, avg: 1983},
        {time_period_id: 8, avg: 583},
        {time_period_id: 9, avg: 84},
        {time_period_id: 10, avg: 7319},
        {time_period_id: 11, avg: 5716}];
    // scatterplot(?) 1
    var xKey1 = "time_period_id";
    var yKey1 = "avg";
    ...
    var myCircle1 = svg1
      ...
      var scLine = d3.line()
      .x(function(d) { return x1(d.time_period_id); })
      .y(function(d) { return y1(d.avg); });
      
      // line code from https://www.d3-graph-gallery.com/graph/line_basic.html
      svg1.append("path")
      .datum(lineData)
      .attr("fill", "none")
  ...
  function updateChart1(brushEvent) {
    ...
    myCircle2.classed("selected", (d) => {
      return isBrushed(extent, x1(d[xKey1]));
    });
  }
  ...
  function updateChart2(brushEvent) {
    ...
    myCircle2.classed("selected", (d) => {
      ...
      if (brushed) selectedSpecies.add(d.time_period_id);
      return brushed;
    });
    myCircle1.classed("selected", (d) => {
